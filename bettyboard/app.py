...
external_scripts = ['/assets/js/light-bootstrap-dashboard.js?v=2.0.1']
...
leftitem = html.Div([
    html.Div(className='logo', children=[
        html.A(className='simple-text logo-mini',
               href='http://www.creative-tim.com', children='Ct'),
        html.A(className='simple-text logo-normal',
               href='http://www.creative-tim.com', children='Creative Tim')
    ]),
        ...
        html.Div(
            ...
            children=[
                html.Button(
                    ...
                    #script='alert("Custom script for button");'
                )
            ]
        ),
        html.A(className="navbar-brand",
               href="#pablo", children="Dashboard PRO")
    ]
)
btnbtn = html.Button([
...
app_dash.layout = html.Div([
    html.Div(className='wrapper', children=[
        ...
        html.Div(
            ...
            style={
                'background-image': app_dash.get_asset_url("../assets/img/sidebar-5.jpg")
            }
